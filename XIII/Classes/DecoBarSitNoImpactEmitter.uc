...
//
//-----------------------------------------------------------
class DecoBarSitNoImpactEmitter extends BaseDecoEmitters;


defaultproperties
{
     Begin Object Class=MeshEmitter Name=DecoBarSitNoImpactEmitterA
         ...
         Name="DecoBarSitNoImpactEmitterA"
     End Object
     Emitters(0)=MeshEmitter'XIII.DecoBarSitNoImpactEmitter.DecoBarSitNoImpactEmitterA'
     bUnlit=True
