...
//
//-----------------------------------------------------------
class DecoShovelSnowImpactEmitter extends BaseDecoEmitters;



defaultproperties
{
     Begin Object Class=MeshEmitter Name=DecoShovelSnowImpactEmitterA
         StaticMesh=StaticMesh'StaticExplosifs.shovelsnowfragment'
         ...
         Name="DecoShovelSnowImpactEmitterA"
     End Object
     Emitters(0)=MeshEmitter'XIII.DecoShovelSnowImpactEmitter.DecoShovelSnowImpactEmitterA'
     Begin Object Class=SpriteEmitter Name=DecoShovelSnowImpactEmitterB
         FadeOut=True
         RespawnDeadParticles=False
         UseSizeScale=True
         ...
         Name="DecoShovelSnowImpactEmitterB"
     End Object
     Emitters(1)=SpriteEmitter'XIII.DecoShovelSnowImpactEmitter.DecoShovelSnowImpactEmitterB'
     Begin Object Class=SpriteEmitter Name=DecoShovelSnowImpactEmitterC
         FadeOut=True
         FadeIn=True
         RespawnDeadParticles=False
         SpinParticles=True
         ...
         Name="DecoShovelSnowImpactEmitterC"
     End Object
     Emitters(2)=SpriteEmitter'XIII.DecoShovelSnowImpactEmitter.DecoShovelSnowImpactEmitterC'
