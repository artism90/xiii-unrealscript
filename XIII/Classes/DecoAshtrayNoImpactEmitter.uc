...
//
//-----------------------------------------------------------
class DecoAshTrayNoImpactEmitter extends BaseDecoEmitters;



defaultproperties
{
     Begin Object Class=MeshEmitter Name=DecoAshTrayNoImpactEmitterA
         ...
         Name="DecoAshTrayNoImpactEmitterA"
     End Object
     Emitters(0)=MeshEmitter'XIII.DecoAshtrayNoImpactEmitter.DecoAshTrayNoImpactEmitterA'
     bUnlit=True
