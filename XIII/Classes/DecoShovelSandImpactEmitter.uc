...
//
//-----------------------------------------------------------
class DecoShovelSandImpactEmitter extends BaseDecoEmitters;


defaultproperties
{
     Begin Object Class=MeshEmitter Name=DecoShovelSandImpactEmitterA
         StaticMesh=StaticMesh'StaticExplosifs.shovelsandfragment'
         ...
         Name="DecoShovelSandImpactEmitterA"
     End Object
     Emitters(0)=MeshEmitter'XIII.DecoShovelSandImpactEmitter.DecoShovelSandImpactEmitterA'
     Begin Object Class=SpriteEmitter Name=DecoShovelSandImpactEmitterB
         FadeOut=True
         RespawnDeadParticles=False
         UseSizeScale=True
         ...
         Name="DecoShovelSandImpactEmitterB"
     End Object
     Emitters(1)=SpriteEmitter'XIII.DecoShovelSandImpactEmitter.DecoShovelSandImpactEmitterB'
     Begin Object Class=SpriteEmitter Name=DecoShovelSandImpactEmitterC
         FadeOut=True
         FadeIn=True
         RespawnDeadParticles=False
         SpinParticles=True
         ...
         Name="DecoShovelSandImpactEmitterC"
     End Object
     Emitters(2)=SpriteEmitter'XIII.DecoShovelSandImpactEmitter.DecoShovelSandImpactEmitterC'
