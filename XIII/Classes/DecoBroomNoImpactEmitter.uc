...
//
//-----------------------------------------------------------
class DecoBroomNoImpactEmitter extends BaseDecoEmitters;



defaultproperties
{
     Begin Object Class=MeshEmitter Name=DecoBroomNoImpactEmitterA
         ...
         Name="DecoBroomNoImpactEmitterA"
     End Object
     Emitters(0)=MeshEmitter'XIII.DecoBroomNoImpactEmitter.DecoBroomNoImpactEmitterA'
     bUnlit=True
