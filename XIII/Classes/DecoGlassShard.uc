...
//
//-----------------------------------------------------------
class DecoGlassShard extends DecoWeapon;
...
defaultproperties
{
     ...
     AmmoName=Class'XIII.DecoGlassShardAmmo'
     MeshName="XIIIArmes.FpsGlasShardM"
     FireOffset=(X=5.000000,Y=8.000000,Z=-7.000000)
     FiringMode="FM_Throw"
     ShakeMag=0.000000
     shaketime=0.000000
