...
//
//-----------------------------------------------------------
class DecoBroomImpactEmitter extends BaseDecoEmitters;


defaultproperties
{
     Begin Object Class=MeshEmitter Name=DecoBroomImpactEmitterA
         ...
         Name="DecoBroomImpactEmitterA"
     End Object
     Emitters(0)=MeshEmitter'XIII.DecoBroomImpactEmitter.DecoBroomImpactEmitterA'
     Begin Object Class=SpriteEmitter Name=DecoBroomImpactEmitterB
         FadeOut=True
         RespawnDeadParticles=False
         UseSizeScale=True
         ...
         Name="DecoBroomImpactEmitterB"
     End Object
     Emitters(1)=SpriteEmitter'XIII.DecoBroomImpactEmitter.DecoBroomImpactEmitterB'
     Begin Object Class=SpriteEmitter Name=DecoBroomImpactEmitterC
         FadeOut=True
         FadeIn=True
         RespawnDeadParticles=False
         SpinParticles=True
         ...
         Name="DecoBroomImpactEmitterC"
     End Object
     Emitters(2)=SpriteEmitter'XIII.DecoBroomImpactEmitter.DecoBroomImpactEmitterC'
