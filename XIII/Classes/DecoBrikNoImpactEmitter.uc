...
//
//-----------------------------------------------------------
class DecoBrikNoImpactEmitter extends BaseDecoEmitters;



defaultproperties
{
     Begin Object Class=MeshEmitter Name=DecoBrikNoImpactEmitterA
         ...
         Name="DecoBrikNoImpactEmitterA"
     End Object
     Emitters(0)=MeshEmitter'XIII.DecoBrikNoImpactEmitter.DecoBrikNoImpactEmitterA'
     bUnlit=True
