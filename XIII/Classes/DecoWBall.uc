...
//
//-----------------------------------------------------------
class DecoWBall extends DecoWeapon;
...
defaultproperties
{
     ...
     AmmoName=Class'XIII.DecoWBallAmmo'
     MeshName="XIIIArmes.FpsBouleBlancheM"
     ...
     hFireSound=Sound'XIIIsound.Items__BilliardsBallFire.BilliardsBallFire__hBilliardFire'
     hSelectWeaponSound=Sound'XIIIsound.Items__BilliardsBallPick.BilliardsBallPick__hBilliardPick'
     PickupClassName="XIII.WBallDecoPick"
     PlayerViewOffset=(X=8.000000,Y=6.000000,Z=-7.000000)
     ThirdPersonRelativeRotation=(Pitch=16384,Roll=16384)
     AttachmentClass=Class'XIII.WBallAttach'
     ItemName="White Ball"
}
